class ApplicationController < ActionController::Base
  ...
  def check_if_organization_on_subdomain
    ...
    redirect_to "http://#{current_organization.subdomain}.#{ENV['REDIRECT_HOST_PROD']}?redirect=true",
  ...
  def check_if_user_on_subdomain
    ...
    redirect_to "http://#{current_user.organization.subdomain}.#{ENV['REDIRECT_HOST_PROD']}?redirect=true",
                allow_other_host: true
  end
